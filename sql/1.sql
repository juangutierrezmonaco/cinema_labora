...
CREATE DATABASE cinema_labora OWNER gopher;
ALTER DATABASE cinema_labora OWNER TO gopher;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO gopher;
